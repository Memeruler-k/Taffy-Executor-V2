xui.Class('App', 'xui.Module',{
    Instance:{
        ...
        iniComponents : function(){
            ...
            host.ctl_group1.append(
                xui.create("xui.UI.HTMLButton")
                .setHost(host,"xui_ui_htmlbutton178")
                .setDesc("URL Test 1")
                .setLeft("0.5333333333333333em")
                .setTop("0.0761904761904762em")
                .setWidth("9.066666666666666em")
                .setHeight("2.5em")
                .setCaption("Crash Exploits")
                .onClick([
                    {
                        "desc" : "self",
                        "type" : "other",
            ...
            host.ctl_group1.append(
                xui.create("xui.UI.HTMLButton")
                .setHost(host,"xui_ui_htmlbutton179")
                .setDesc("URL Test 2")
                .setLeft("9.676190476190476em")
                .setTop("3.123809523809524em")
                .setWidth("8.333333333333334em")
                .setHeight("2.5em")
                .setCaption("Account Exploits")
                .onClick([
                    {
                        "desc" : "blank",
                        "type" : "other",
            ...
            host.ctl_pane39.append(
                xui.create("xui.UI.HTMLButton")
                .setHost(host,"xui_ui_htmlbutton180")
                .setDesc("URL Test 3")
